...
define("Ytmusicapi\RESPONSIVE_HEADER", "musicResponsiveHeaderRenderer");
...
define("Ytmusicapi\PLAYLIST_ID", "playlistId");
define("Ytmusicapi\WATCH_PLAYLIST_ID", "watchEndpoint.playlistId");
...
define("Ytmusicapi\WATCH_PID", "watchPlaylistEndpoint.playlistId");
...
define("Ytmusicapi\ICON_TYPE", "icon.iconType");
define("Ytmusicapi\TOGGLED_BUTTON", "toggleButtonRenderer.isToggled");
...
define("Ytmusicapi\HEADER", "header");
define("Ytmusicapi\HEADER_DETAIL", "header.musicDetailHeaderRenderer");
define("Ytmusicapi\EDITABLE_PLAYLIST_DETAIL_HEADER", "musicEditablePlaylistDetailHeaderRenderer");
define("Ytmusicapi\HEADER_EDITABLE_DETAIL", "header.musicEditablePlaylistDetailHeaderRenderer");
